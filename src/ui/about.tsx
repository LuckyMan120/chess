  ...
  view() {
    ...
    return layout.free(
      ...
      <div class="aboutBody native_scroller page">
        <p>chess.pro is a free, open-source chess server powered by volunteers and donations.</p>
        ...
        <ul>
          ...
          <li>{externalLink('Patrons', 'http://dev.chess.pro/patron')} provide a steady stream of income to our site, sufficient to run our servers and handle expenses.</li>
