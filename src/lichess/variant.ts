...
const variantMap: {[key in VariantKey]: DocVariant} = {
  ...
  chess960: {
    ...
    tinyName: '960',
    id: 2,
    link: 'http://dev.chess.pro/variant/chess960',
  ...
  kingOfTheHill: {
    ...
    tinyName: 'KotH',
    id: 4,
    link: 'http://dev.chess.pro/variant/kingOfTheHill',
  ...
  threeCheck: {
    ...
    tinyName: '3+',
    id: 5,
    link: 'http://dev.chess.pro/variant/threeCheck',
  ...
  antichess: {
    ...
    tinyName: 'Anti',
    id: 6,
    link: 'http://dev.chess.pro/variant/antichess',
  ...
  atomic: {
    ...
    tinyName: 'Atom',
    id: 7,
    link: 'http://dev.chess.pro/variant/atomic',
  ...
  horde: {
    ...
    tinyName: 'Horde',
    id: 8,
    link: 'http://dev.chess.pro/variant/horde',
  ...
  racingKings: {
    ...
    tinyName: 'Racing',
    id: 9,
    link: 'http://dev.chess.pro/variant/racingKings',
  ...
  crazyhouse: {
    ...
    tinyName: 'Crazy',
    id: 10,
    link: 'http://dev.chess.pro/variant/crazyhouse',
